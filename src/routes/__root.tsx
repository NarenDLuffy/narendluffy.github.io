...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", sizes: "64x64", href: "/icon-64.png?v=4" },
      { rel: "icon", type: "image/png", sizes: "192x192", href: "/icon-192.png?v=4" },
      { rel: "icon", type: "image/png", sizes: "512x512", href: "/icon-512.png?v=4" },
      { rel: "shortcut icon", type: "image/png", href: "/icon-64.png?v=4" },
      { rel: "apple-touch-icon", sizes: "192x192", href: "/icon-192.png?v=4" },
