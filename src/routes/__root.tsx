...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", sizes: "64x64", href: "/favicon.png?v=3gpp" },
      { rel: "shortcut icon", type: "image/png", href: "/favicon.png?v=3gpp" },
      { rel: "apple-touch-icon", href: "/favicon.png?v=3gpp" },
